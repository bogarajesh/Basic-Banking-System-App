package com.example.basicbankingsystem.ListAdapters;
...
import com.example.basicbankingsystem.Data.Transaction;
import com.example.basicbankingsystem.R;

import java.util.ArrayList;

public class TransactionHistroyAdapter extends RecyclerView.Adapter<TransactionHistroyAdapter.ViewHolder> {
    private ArrayList<Transaction> transactionArrayList;

    public TransactionHistroyAdapter(Context context, ArrayList<Transaction> list) {
    ...
    @NonNull
    @Override
    public TransactionHistroyAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from (viewGroup.getContext()).inflate(R.layout.trancastion_histroy_item, viewGroup, false);
