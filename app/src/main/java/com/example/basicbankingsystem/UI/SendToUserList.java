...
import com.example.basicbankingsystem.DB.TransactionContract;
import com.example.basicbankingsystem.DB.TransactionHelper;
import com.example.basicbankingsystem.DB.UserContract;
import com.example.basicbankingsystem.DB.UserHelper;
import com.example.basicbankingsystem.Data.User;
import com.example.basicbankingsystem.ListAdapters.SendToUserAdapter;
...
public class SendToUserList extends AppCompatActivity implements SendToUserAdapter.OnUserListener {
    ...
    public void onUserClick(int position) {
        ...
        startActivity(new Intent(SendToUserList.this, MainActivity.class));
        finish();
    }
        ...
        builder_exitButton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton ("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick (DialogInterface dialogInterface, int i) {
                        ...
                        Toast.makeText(SendToUserList.this, "Transaction Cancelled!", Toast.LENGTH_SHORT).show();
